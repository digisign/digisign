...
public class ImportCsv {
	...
	public static void readCsv()
	{
		...
		try (CSVReader reader = new CSVReader(new FileReader("C:\\Users\\Hp\\Documents\\GitHub\\TestCredential\\temporarydata.csv"), ','); 
	...
	public static void readCsvUsingLoad()
	{
		...
		try (Connection connection = DBConnection.getConnection())
		{
				...
				String loadQuery = "LOAD DATA LOCAL INFILE '" + "C:\\Users\\Hp\\Documents\\GitHub\\TestCredential\\temporarydata.csv" + "' INTO TABLE temporarydata FIELDS TERMINATED BY ',' ENCLOSED BY '\"' ESCAPED BY '\'" + " LINES TERMINATED BY '\n' (Institution_Name, Mobile_Number_1, Mobile_Number_2, Email_Id_1, Email_Id_2, Address_1, Address_2, Address_3, City, State, Country, Postal_Code) ";
