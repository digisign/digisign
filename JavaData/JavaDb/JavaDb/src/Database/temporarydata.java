...
public class temporarydata implements Serializable {
	...
	public temporarydata(String InstitutionName,Integer MobileNumber1,Integer MobileNumber2, String EmailId1, String EmailId2, String Address1, String Address2, String Address3,
			String City, String State, String Country, Integer PostalCode) {
		super();
